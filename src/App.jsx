...
function InventoryModal({ initial, defaultLocation, defaultCategory, onSave, onDelete, onClose }) {
  ...
  const handleSave = () => {
    ...
    onSave({
      ...
      minStock: Number(minStock) || 0, expiry: expiry || null, location, packageSize,
    });
  };
